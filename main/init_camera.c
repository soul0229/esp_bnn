...
#endif
static const char *TAG = "init_camera.c";
...
data_info_t *get_32x32_jpg(){
    ...
    data_info_t *RGB888 = malloc(sizeof(data_info_t));
    memset(RGB888,0x00,sizeof(data_info_t));
    RGB888->data = malloc(32*32*3);
    RGB888->len = ONE_BYTE;
    RGB888->dim[0] = 1;
    RGB888->dim[1] = 3;
    RGB888->dim[2] = 32;
    ...
    struct RGB_CH (*data)[pic->width] = pic->buf;
    
    uint8_t (*RGB_OUT)[32][32] = RGB888->data;
